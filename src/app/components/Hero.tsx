        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0">
              ...
              full-stack applications using MongoDB, Express.js, React, Next.js, SQL and Node.js.
            </p>
            <div className="flex justify-center lg:justify-start space-x-6 mb-8">
              <a
                href="#"
                className="p-4 rounded-full bg-white hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 transition-colors duration-300 shadow-lg hover:shadow-xl"
            ...
            <motion.button
              ...
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl"
